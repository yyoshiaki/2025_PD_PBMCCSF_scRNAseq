...
version = f'241010_scvi_BLD_subcluster_B'

f_adata = '/home/yy693/pi_hafler/ASAP/scanpy/241006_scvi_BLD_doublet0.15_addribo_removelowribo_chem/241006_scvi_BLD_doublet0.15_addribo_removelowribo_chem.celltypist.scrubletall.h5ad'
# f_cl1 = '/vast/palmer/home.mccleary/yy693/cellxgene-data/yy693/Yale/ASAP/241006_scvi_BLD_doublet0.15_addribo_removelowribo_chem.cxg.celltypist.scrubletall_annotations/241015.csv'
f_cl1 = '/vast/palmer/pi/hafler/yy693/ASAP/scanpy/241006_scvi_BLD_doublet0.15_addribo_removelowribo_chem/241015.csv'
cluster = 'B'
...
list_sample_sufficient = list(adata.obs.SampleID.value_counts()[adata.obs.SampleID.value_counts() > 10].index)
a = adata[adata.obs.SampleID.isin(list_sample_sufficient)]
df_res = sc.pp.highly_variable_genes(a, n_top_genes=3000, batch_key = 'SampleID', inplace=False)
adata.var = pd.merge(adata.var.loc[:,~adata.var.columns.isin(df_res.columns)], df_res, left_index=True, right_index=True)
