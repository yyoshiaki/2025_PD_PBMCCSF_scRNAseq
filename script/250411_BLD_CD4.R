...
prefix.output <- "./output/250411_BLD_CD4T"

df.obs <- read_csv('./scanpy/250407_BLD_downstream//obs.csv')
df.gex <- read_csv('./data/241024_cellranger_files_GEX.csv') %>% filter(SampleType == 'BLD')
